...
Implement the user-approved production architecture for secure public access,
Google sign-in, durable storage, backups, monitoring, and rollback.
...
- [ ] User-approved hosting, domain, region, budget, OAuth, storage, backup, and retention choices are recorded before provisioning.
- [ ] HTTPS, secure sessions, Google OAuth validation, CSRF/CORS, secret handling, and privacy-safe logging are verified in the deployed configuration.
