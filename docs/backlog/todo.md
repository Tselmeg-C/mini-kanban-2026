...
- [ ] IN PROGRESS (scope correction; QA pending) — [#4 Implement the local kanban API and session boundary](4-implement-local-kanban-api-and-session-boundary.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/4) · depends on #3
