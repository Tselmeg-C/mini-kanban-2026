...
**NEXT: #5 — Resolve API client refresh QA findings.**
...
- [ ] IN PROGRESS (independent QA PARTIAL) — [#5 Connect the kanban interface to the API and refresh changes](5-connect-kanban-interface-to-api-and-refresh-changes.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/5) · depends on #4
- [ ] IN PROGRESS (independent QA PARTIAL) — [#6 Persist boards and tasks in SQLite](6-persist-boards-and-tasks-in-sqlite.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/6) · depends on #5
- [ ] IN PROGRESS (independent QA FAIL) — [#7 Verify local user journeys and document setup](7-verify-local-user-journeys-and-document-setup.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/7) · depends on #6
