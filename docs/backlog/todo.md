...
**NEXT: #8 — Plan cross-device release and hosting.**
...
- [x] DONE locally (QA PASS; GitHub sync pending) — [#5 Connect the kanban interface to the API and refresh changes](5-connect-kanban-interface-to-api-and-refresh-changes.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/5) · depends on #4
- [x] DONE (QA PASS; GitHub issue closed) — [#6 Persist boards and tasks in SQLite](6-persist-boards-and-tasks-in-sqlite.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/6) · depends on #5
- [x] DONE locally (QA PASS; release gaps documented; GitHub sync pending) — [#7 Verify local user journeys and document setup](7-verify-local-user-journeys-and-document-setup.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/7) · depends on #6
