...
- [x] DONE (QA PASS; release gaps documented; GitHub issue closed) — [#7 Verify local user journeys and document setup](7-verify-local-user-journeys-and-document-setup.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/7) · depends on #6
