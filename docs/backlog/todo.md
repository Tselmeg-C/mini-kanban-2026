...
**NEXT: #7 — Verify local user journeys and document setup.**
...
- [x] DONE locally (QA PASS; GitHub sync pending) — [#6 Persist boards and tasks in SQLite](6-persist-boards-and-tasks-in-sqlite.md) · [GitHub](https://github.com/Tselmeg-C/mini-kanban-2026/issues/6) · depends on #5
